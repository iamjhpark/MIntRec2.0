...
from backbones.single_turn.base import ModelManager
...
def parse_arguments():
    ...
    parser.add_argument('--video_feats', type=str, default='resnet50-roi', help="The directory of the video features.")
